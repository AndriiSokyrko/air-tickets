...
import {getFlights, updateStateFlights} from "../../store/slices/flightsSlice.ts";
...
export default function PrimarySearchAppBar({ openCart }) {
    ...
    // Оборачиваем фильтрацию в debounce один раз
